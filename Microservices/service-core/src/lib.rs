...
//! program". This file, `lib.rs`, is the root of a *library* crate: it
//! produces no executable, it is linked into other crates that depend on it.
//!
...
//! browsable Hypertext Markup Language manual:
//!
//! ```text
//! cargo doc --open
//! ```
...
//! once and continuous integration's affected-crate detection fans it out to
//! every dependent.
